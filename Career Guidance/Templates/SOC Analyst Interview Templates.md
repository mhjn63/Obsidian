...
- [[#SOC/EDR Interview Answers Templates and Scenarios|SOC/EDR Interview Answers Templates and Scenarios]]
	- [[#SOC/EDR Interview Answers Templates and Scenarios#1. Initial Impression & Immediate Red Flags|1. Initial Impression & Immediate Red Flags]]
	- [[#SOC/EDR Interview Answers Templates and Scenarios#Containment Decision|Containment Decision]]
	- [[#SOC/EDR Interview Answers Templates and Scenarios#3. Detailed Breakdown of the Command or Artifact|3. Detailed Breakdown of the Command or Artifact]]
	- [[#SOC/EDR Interview Answers Templates and Scenarios#4. Parent/Child Process Validation|4. Parent/Child Process Validation]]
	- [[#SOC/EDR Interview Answers Templates and Scenarios#5. Network & URL Investigation|5. Network & URL Investigation]]
	- [[#SOC/EDR Interview Answers Templates and Scenarios#6. Timeline & Lateral Movement Checks|6. Timeline & Lateral Movement Checks]]
	- [[#SOC/EDR Interview Answers Templates and Scenarios#7. Persistence Checks|7. Persistence Checks]]
	- [[#SOC/EDR Interview Answers Templates and Scenarios#8. Data Exfiltration & Credential Exposure Analysis|8. Data Exfiltration & Credential Exposure Analysis]]
	- [[#SOC/EDR Interview Answers Templates and Scenarios#9. Remediation Recommendation|9. Remediation Recommendation]]
	- [[#SOC/EDR Interview Answers Templates and Scenarios#10. Prevention & Hardening|10. Prevention & Hardening]]
	- [[#SOC/EDR Interview Answers Templates and Scenarios#11. Documentation|11. Documentation]]
	- [[#SOC/EDR Interview Answers Templates and Scenarios#One-Sentence Closing Line|One-Sentence Closing Line]]
- [[#SOC/ DFIR / IR Interview Answers Templates and Scenarios|SOC/ DFIR / IR Interview Answers Templates and Scenarios]]
	- [[#SOC/ DFIR / IR Interview Answers Templates and Scenarios#1. Executive Snapshot|1. Executive Snapshot]]
	- [[#SOC/ DFIR / IR Interview Answers Templates and Scenarios#2. SOC Priority #1 : Containment Decision|2. SOC Priority #1 : Containment Decision]]
	- [[#SOC/ DFIR / IR Interview Answers Templates and Scenarios#3. Technical Breakdown of the Artifact / Command|3. Technical Breakdown of the Artifact / Command]]
	- [[#SOC/ DFIR / IR Interview Answers Templates and Scenarios#4. Parent / Child Process Validation|4. Parent / Child Process Validation]]
	- [[#SOC/ DFIR / IR Interview Answers Templates and Scenarios#5. Network Connection & C2 Analysis|5. Network Connection & C2 Analysis]]
	- [[#SOC/ DFIR / IR Interview Answers Templates and Scenarios#6. DFIR Timeline Reconstruction|6. DFIR Timeline Reconstruction]]
	- [[#SOC/ DFIR / IR Interview Answers Templates and Scenarios#7. Persistence Mechanism Identification|7. Persistence Mechanism Identification]]
	- [[#SOC/ DFIR / IR Interview Answers Templates and Scenarios#8. Lateral Movement Assessment|8. Lateral Movement Assessment]]
	- [[#SOC/ DFIR / IR Interview Answers Templates and Scenarios#9. Data Theft / Exfiltration Review|9. Data Theft / Exfiltration Review]]
	- [[#SOC/ DFIR / IR Interview Answers Templates and Scenarios#10. Remediation Recommendation|10. Remediation Recommendation]]
	- [[#SOC/ DFIR / IR Interview Answers Templates and Scenarios#11. Hardening & Prevention|11. Hardening & Prevention]]
	- [[#SOC/ DFIR / IR Interview Answers Templates and Scenarios#12. Documentation & IR Reporting|12. Documentation & IR Reporting]]
	- [[#SOC/ DFIR / IR Interview Answers Templates and Scenarios#Professional Closing Line for Interviews|Professional Closing Line for Interviews]]
- [[#SOC/DFIR Example Answers|SOC/DFIR Example Answers]]
	- [[#SOC/DFIR Example Answers#Example Scenario 1 : Suspicious PowerShell Command Execution|Example Scenario 1 : Suspicious PowerShell Command Execution]]
	- [[#SOC/DFIR Example Answers#Scenario Prompt|Scenario Prompt]]
		- [[#Scenario Prompt#Example Answer|Example Answer]]
	- [[#SOC/DFIR Example Answers#Example Scenario 2 : Suspicious Scheduled Task Detected|Example Scenario 2 : Suspicious Scheduled Task Detected]]
	- [[#SOC/DFIR Example Answers#Scenario Prompt|Scenario Prompt]]
		- [[#Scenario Prompt#Example Answer|Example Answer]]
	- [[#SOC/DFIR Example Answers#Example Scenario 3 : Unknown Process Running on Endpoint|Example Scenario 3 : Unknown Process Running on Endpoint]]
	- [[#SOC/DFIR Example Answers#Scenario Prompt|Scenario Prompt]]
		- [[#Scenario Prompt#Example Answer|Example Answer]]
	- [[#SOC/DFIR Example Answers#Example Scenario 4 : Encoded Command Hidden in Command Line|Example Scenario 4 : Encoded Command Hidden in Command Line]]
	- [[#SOC/DFIR Example Answers#**Scenario Prompt:**|**Scenario Prompt:**]]
		- [[#**Scenario Prompt:**#Example Answer|Example Answer]]
- [[#Advanced real-world scenarios|Advanced real-world scenarios]]
	- [[#Advanced real-world scenarios#Scenario 1 : C2 Beaconing Detected Every 60 Seconds|Scenario 1 : C2 Beaconing Detected Every 60 Seconds]]
		- [[#Scenario 1 : C2 Beaconing Detected Every 60 Seconds#Telemetry|Telemetry]]
		- [[#Scenario 1 : C2 Beaconing Detected Every 60 Seconds#Model Answer|Model Answer]]
	- [[#Advanced real-world scenarios#Scenario 2 : LSASS Memory Access Attempt|Scenario 2 : LSASS Memory Access Attempt]]
		- [[#Scenario 2 : LSASS Memory Access Attempt#Telemetry|Telemetry]]
		- [[#Scenario 2 : LSASS Memory Access Attempt#Model Answer|Model Answer]]
	- [[#Advanced real-world scenarios#✅ Scenario 3 : Kerberoasting Behavior Detected|✅ Scenario 3 : Kerberoasting Behavior Detected]]
		- [[#✅ Scenario 3 : Kerberoasting Behavior Detected#Telemetry|Telemetry]]
		- [[#✅ Scenario 3 : Kerberoasting Behavior Detected#Model Answer|Model Answer]]
	- [[#Advanced real-world scenarios#Scenario 4 : SMB Brute-Force Attack|Scenario 4 : SMB Brute-Force Attack]]
		- [[#Scenario 4 : SMB Brute-Force Attack#Telemetr|Telemetr]]
		- [[#Scenario 4 : SMB Brute-Force Attack#Model Answer|Model Answer]]
	- [[#Advanced real-world scenarios#Scenario 5:  Unknown Binary Exhibiting Evasion Techniques|Scenario 5:  Unknown Binary Exhibiting Evasion Techniques]]
		- [[#Scenario 5:  Unknown Binary Exhibiting Evasion Techniques#Telemetry|Telemetry]]
		- [[#Scenario 5:  Unknown Binary Exhibiting Evasion Techniques#Model Answer|Model Answer]]
	- [[#Advanced real-world scenarios#Scenario 6 : Suspicious Persistence via WMI Subscription|Scenario 6 : Suspicious Persistence via WMI Subscription]]
		- [[#Scenario 6 : Suspicious Persistence via WMI Subscription#Telemetry|Telemetry]]
		- [[#Scenario 6 : Suspicious Persistence via WMI Subscription#Model Answer|Model Answer]]
	- [[#Advanced real-world scenarios#Scenario 7 : C2 Using DNS Tunneling|Scenario 7 : C2 Using DNS Tunneling]]
		- [[#Scenario 7 : C2 Using DNS Tunneling#Telemetry|Telemetry]]
		- [[#Scenario 7 : C2 Using DNS Tunneling#Model Answer|Model Answer]]
- [[#Live Interview-Style Questions With Perfect Answers|Live Interview-Style Questions With Perfect Answers]]
	- [[#Live Interview-Style Questions With Perfect Answers#Q1: You identify LSASS access. What is your immediate response?|Q1: You identify LSASS access. What is your immediate response?]]
	- [[#Live Interview-Style Questions With Perfect Answers#Q2: What signs tell you a PowerShell command is malicious?|Q2: What signs tell you a PowerShell command is malicious?]]
	- [[#Live Interview-Style Questions With Perfect Answers#Q3: How do you confirm C2 activity?|Q3: How do you confirm C2 activity?]]
	- [[#Live Interview-Style Questions With Perfect Answers#Q4: What do you do if you find a malicious scheduled task?|Q4: What do you do if you find a malicious scheduled task?]]
	- [[#Live Interview-Style Questions With Perfect Answers#Q5: How do you handle Kerberoasting detection?|Q5: How do you handle Kerberoasting detection?]]
- [[#30-Question SOC Analyst Interview Pack|30-Question SOC Analyst Interview Pack]]
	- [[#30-Question SOC Analyst Interview Pack#Technical Detection & Alert Response|Technical Detection & Alert Response]]
	- [[#30-Question SOC Analyst Interview Pack#Active Directory & Windows Internals|Active Directory & Windows Internals]]
	- [[#30-Question SOC Analyst Interview Pack#Network & Protocol Knowledge|Network & Protocol Knowledge]]
	- [[#30-Question SOC Analyst Interview Pack#IR / DFIR Methodology|IR / DFIR Methodology]]
	- [[#30-Question SOC Analyst Interview Pack#Tooling & Platforms|Tooling & Platforms]]
- [[#SOC Interview Strategy Cheat Sheet|SOC Interview Strategy Cheat Sheet]]
	- [[#SOC Interview Strategy Cheat Sheet#SOC INTERVIEW CHEAT SHEET|SOC INTERVIEW CHEAT SHEET]]
- [[#Done !|Done !]]
