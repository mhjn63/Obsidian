...
- [[#Windows Internals and Components|Windows Internals and Components]]
	- [[#Windows Internals and Components#Processes|Processes]]
	- [[#Windows Internals and Components#DLLs|DLLs]]
	- [[#Windows Internals and Components#Portable Executable Format|Portable Executable Format]]
	- [[#Windows Internals and Components#Threads|Threads]]
	- [[#Windows Internals and Components#Virtual Memory|Virtual Memory]]
- [[#Description of Common Directories and Registry Keys in Windows|Description of Common Directories and Registry Keys in Windows]]
	- [[#Description of Common Directories and Registry Keys in Windows#Directories|Directories]]
	- [[#Description of Common Directories and Registry Keys in Windows#Registry|Registry]]
- [[#Networking|Networking]]
	- [[#Networking#Auditing Network Settings & Connections|Auditing Network Settings & Connections]]
	- [[#Networking#Windows Port forwarding|Windows Port forwarding]]
		- [[#Windows Port forwarding#With Netsh command|With Netsh command]]
	- [[#Networking#Network Shares|Network Shares]]
	- [[#Networking#Netsh Utility|Netsh Utility]]
- [[#Management|Management]]
	- [[#Management#System Info|System Info]]
	- [[#Management#System Management Tools|System Management Tools]]
		- [[#System Management Tools#Troubleshooting Tool|Troubleshooting Tool]]
		- [[#System Management Tools#Manage UAC|Manage UAC]]
		- [[#System Management Tools#Computer Management Tool|Computer Management Tool]]
		- [[#System Management Tools#View Sys Info Tool|View Sys Info Tool]]
		- [[#System Management Tools#Resource Monitor Tool|Resource Monitor Tool]]
		- [[#System Management Tools#Group Policy Management|Group Policy Management]]
		- [[#System Management Tools#Regular Windows|Regular Windows]]
		- [[#System Management Tools#Managing users|Managing users]]
			- [[#Managing users#Windows Server without AD|Windows Server without AD]]
		- [[#System Management Tools#Netview Tool|Netview Tool]]
		- [[#System Management Tools#PSexec|PSexec]]
	- [[#Management#User Info and Management|User Info and Management]]
- [[#Services and processes|Services and processes]]
- [[#File and Directory Management|File and Directory Management]]
		- [[#User Info and Management#Directories|Directories]]
		- [[#User Info and Management#Viewing Files|Viewing Files]]
		- [[#User Info and Management#Searching Files|Searching Files]]
		- [[#User Info and Management#Prcoessing|Prcoessing]]
		- [[#User Info and Management#Permissions Management|Permissions Management]]
- [[#Startup and Autorun Management|Startup and Autorun Management]]
- [[#Windows Event Logs|Windows Event Logs]]
	- [[#Windows Event Logs#Definition|Definition]]
	- [[#Windows Event Logs#Elements of Event Logs|Elements of Event Logs]]
	- [[#Windows Event Logs#Tools|Tools]]
- [[#Troubleshooting|Troubleshooting]]
	- [[#Troubleshooting#Fixing corrupted system files|Fixing corrupted system files]]
	- [[#Troubleshooting#Hard Disk not detected when installing windows from usb|Hard Disk not detected when installing windows from usb]]
	- [[#Troubleshooting#Java Error 1603|Java Error 1603]]
		- [[#Java Error 1603#Choose earlier version to install|Choose earlier version to install]]
		- [[#Java Error 1603#Disable The current AV|Disable The current AV]]
		- [[#Java Error 1603#Use Microsoft install/uninstall troubleshooter|Use Microsoft install/uninstall troubleshooter]]
		- [[#Java Error 1603#Delete KB2918614 Update|Delete KB2918614 Update]]
	- [[#Troubleshooting#Fix System corrupted files|Fix System corrupted files]]
	- [[#Troubleshooting#Fixing BSOD|Fixing BSOD]]
		- [[#Fixing BSOD#1. Download and Run BlueScreenView|1. Download and Run BlueScreenView]]
		- [[#Fixing BSOD#2. Scan for Crash Dumps|2. Scan for Crash Dumps]]
		- [[#Fixing BSOD#3. Analyze Crash Information|3. Analyze Crash Information]]
		- [[#Fixing BSOD#4. Identify the Faulty Driver or Module|4. Identify the Faulty Driver or Module]]
		- [[#Fixing BSOD#5. Apply the Fix|5. Apply the Fix]]
		- [[#Fixing BSOD#6. Reboot and Test|6. Reboot and Test]]
	- [[#Troubleshooting#Fixing winload.exe is missing or corrupt issue on Windows 7 startup|Fixing winload.exe is missing or corrupt issue on Windows 7 startup]]
	- [[#Troubleshooting#Fixing Startup Issues|Fixing Startup Issues]]
- [[#Windows Security and Hardening|Windows Security and Hardening]]
	- [[#Windows Security and Hardening#Disable Always Install Elevated|Disable Always Install Elevated]]
	- [[#Windows Security and Hardening#Anti-KeyLoggers|Anti-KeyLoggers]]
	- [[#Windows Security and Hardening#Windows Defender and Windows Firewall|Windows Defender and Windows Firewall]]
		- [[#Windows Defender and Windows Firewall#Windows Defender|Windows Defender]]
		- [[#Windows Defender and Windows Firewall#Network Profiles in Windows Firewall|Network Profiles in Windows Firewall]]
		- [[#Windows Defender and Windows Firewall#Managing Firewall Settings|Managing Firewall Settings]]
		- [[#Windows Defender and Windows Firewall#Creating a Custom Firewall Rule|Creating a Custom Firewall Rule]]
		- [[#Windows Defender and Windows Firewall#Firewall Operations|Firewall Operations]]
		- [[#Windows Defender and Windows Firewall#Windows Smart Screen|Windows Smart Screen]]
	- [[#Windows Security and Hardening#Disable Modifying Scheduled Tasks|Disable Modifying Scheduled Tasks]]
	- [[#Windows Security and Hardening#Disable RunOnce|Disable RunOnce]]
	- [[#Windows Security and Hardening#Enabling Credential Guard|Enabling Credential Guard]]
	- [[#Windows Security and Hardening#Enable UAC|Enable UAC]]
	- [[#Windows Security and Hardening#Setting a Password Policy|Setting a Password Policy]]
	- [[#Windows Security and Hardening#Setting a lockout policy|Setting a lockout policy]]
	- [[#Windows Security and Hardening#Disabling RDP and SMB|Disabling RDP and SMB]]
	- [[#Windows Security and Hardening#Application Security|Application Security]]
		- [[#Application Security#Installing apps only from Microsoft store|Installing apps only from Microsoft store]]
		- [[#Application Security#Running Applications from a sandbox|Running Applications from a sandbox]]
		- [[#Application Security#Control App Execution Rules Through AppLocker|Control App Execution Rules Through AppLocker]]
	- [[#Windows Security and Hardening#Enabling Microsoft Smartscreen|Enabling Microsoft Smartscreen]]
	- [[#Windows Security and Hardening#Boot Security|Boot Security]]
	- [[#Windows Security and Hardening#Virus and Malware Removal|Virus and Malware Removal]]
		- [[#Virus and Malware Removal#Automated Removal with Removal Tools|Automated Removal with Removal Tools]]
	- [[#Windows Security and Hardening#Disk Encryption|Disk Encryption]]
- [[#Backup and Recovery|Backup and Recovery]]
	- [[#Backup and Recovery#Group Policy Update and Recovery|Group Policy Update and Recovery]]
	- [[#Backup and Recovery#Volume Shadow Service|Volume Shadow Service]]
	- [[#Backup and Recovery#Winlogon Password Recovery|Winlogon Password Recovery]]
		- [[#Winlogon Password Recovery#Active@ Password Changer|Active@ Password Changer]]
			- [[#Active@ Password Changer#Step-by-Step Guide to Using Active@ Password Changer|Step-by-Step Guide to Using Active@ Password Changer]]
		- [[#Winlogon Password Recovery#The Offline NT Password & Registry Editor|The Offline NT Password & Registry Editor]]
		- [[#Winlogon Password Recovery#Ophcrack|Ophcrack]]
			- [[#Ophcrack#Method 1: Using Ophcrack LiveCD (Simplest Approach)|Method 1: Using Ophcrack LiveCD (Simplest Approach)]]
			- [[#Ophcrack#Method 2: Using the Ophcrack Windows Application (Advanced)|Method 2: Using the Ophcrack Windows Application (Advanced)]]
- [[#BIOS Management|BIOS Management]]
	- [[#BIOS Management#BIOS Update|BIOS Update]]
- [[#Resources and Links|Resources and Links]]
	- [[#Resources and Links#Utilities and programs|Utilities and programs]]
	- [[#Resources and Links#Network Tools|Network Tools]]
		- [[#Network Tools#Network Monitor|Network Monitor]]
		- [[#Network Tools#Anonymous SMS Senders|Anonymous SMS Senders]]
		- [[#Network Tools#Anonymous Email Senders|Anonymous Email Senders]]
	- [[#Resources and Links#Video Tools|Video Tools]]
	- [[#Resources and Links#File Processing Tools|File Processing Tools]]
	- [[#Resources and Links#Email Tools|Email Tools]]
	- [[#Resources and Links#Security Tools|Security Tools]]
	- [[#Resources and Links#Backup and Recovery Tools|Backup and Recovery Tools]]
	- [[#Resources and Links#AVs|AVs]]
	- [[#Resources and Links#Collaboration and Sharing Tools|Collaboration and Sharing Tools]]
	- [[#Resources and Links#FlashBoot|FlashBoot]]
	- [[#Resources and Links#Privacy & Security Tools|Privacy & Security Tools]]
	- [[#Resources and Links#Recovering Lost License Keys|Recovering Lost License Keys]]
	- [[#Resources and Links#Windows Repair Toolbox|Windows Repair Toolbox]]
		- [[#Windows Repair Toolbox#Features|Features]]
		- [[#Windows Repair Toolbox#How to Use|How to Use]]
