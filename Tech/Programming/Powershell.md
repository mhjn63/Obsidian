...
- [[#Setup|Setup]]
	- [[#Setup#Install PowerShell|Install PowerShell]]
	- [[#Setup#Launch PowerShell|Launch PowerShell]]
	- [[#Setup#Verify the Execution Policy|Verify the Execution Policy]]
	- [[#Setup#Possible Execution Policy Values|Possible Execution Policy Values]]
	- [[#Setup#Modifying the Execution Policy|Modifying the Execution Policy]]
- [[#Basics of cmdlets and modules|Basics of cmdlets and modules]]
	- [[#Basics of cmdlets and modules#Basic Syntax: Verb-Noun|Basic Syntax: Verb-Noun]]
	- [[#Basics of cmdlets and modules#Basic Cmdlets|Basic Cmdlets]]
	- [[#Basics of cmdlets and modules#Downloading External Cmdlets|Downloading External Cmdlets]]
- [[#Data Types in Powershell|Data Types in Powershell]]
	- [[#Data Types in Powershell#Common Data Types in PowerShell|Common Data Types in PowerShell]]
- [[#Variables in Powershell|Variables in Powershell]]
	- [[#Variables in Powershell#Key Features of PowerShell Variables:|Key Features of PowerShell Variables:]]
	- [[#Variables in Powershell#Assigning Values to Variables|Assigning Values to Variables]]
			- [[#Examples:|Examples:]]
- [[#Pipes|Pipes]]
	- [[#Pipes#Examples:|Examples:]]
	- [[#Pipes#Example: Filtering and Formatting Service Names|Example: Filtering and Formatting Service Names]]
	- [[#Pipes#Explanation:|Explanation:]]
	- [[#Pipes#Result:|Result:]]
- [[#File System Navigation|File System Navigation]]
- [[#Working with Date and Time|Working with Date and Time]]
	- [[#Working with Date and Time#Examples:|Examples:]]
- [[#Filtering and Sorting|Filtering and Sorting]]
- [[#Interacting with The Web|Interacting with The Web]]
	- [[#Interacting with The Web#Send HTTP GET Requests|Send HTTP GET Requests]]
	- [[#Interacting with The Web#Send HTTP POST Requests|Send HTTP POST Requests]]
	- [[#Interacting with The Web#Download a File from the Web|Download a File from the Web]]
	- [[#Interacting with The Web#Work with JSON APIs|Work with JSON APIs]]
	- [[#Interacting with The Web#Scrape Web Page Data|Scrape Web Page Data]]
	- [[#Interacting with The Web#Interact with REST APIs|Interact with REST APIs]]
	- [[#Interacting with The Web#Send Custom HTTP Headers|Send Custom HTTP Headers]]
	- [[#Interacting with The Web#Work with HTML Content|Work with HTML Content]]
	- [[#Interacting with The Web#Test Website Availability|Test Website Availability]]
	- [[#Interacting with The Web#Upload a File to a Web Server|Upload a File to a Web Server]]
- [[#System Management|System Management]]
	- [[#System Management#System Info & User Management|System Info & User Management]]
	- [[#System Management#Networking|Networking]]
	- [[#System Management#Processes and Services|Processes and Services]]
	- [[#System Management#Software and Package Management|Software and Package Management]]
		- [[#Software and Package Management#Installing and Configuring Software|Installing and Configuring Software]]
	- [[#System Management#Scheduled Tasks|Scheduled Tasks]]
	- [[#System Management#Remote Systems|Remote Systems]]
	- [[#System Management#Backup and Restore Configuration|Backup and Restore Configuration]]
	- [[#System Management#Monitoring and Reporting|Monitoring and Reporting]]
	- [[#System Management#Active Directory|Active Directory]]
- [[#Powershell Remoting|Powershell Remoting]]
	- [[#Powershell Remoting#Key Features of PowerShell Remoting|Key Features of PowerShell Remoting]]
	- [[#Powershell Remoting#Enabling PowerShell Remoting|Enabling PowerShell Remoting]]
		- [[#Enabling PowerShell Remoting#Enable Remoting on a System|Enable Remoting on a System]]
	- [[#Powershell Remoting#PowerShell Remoting Modes|PowerShell Remoting Modes]]
		- [[#PowerShell Remoting Modes#1. Interactive Remoting|1. Interactive Remoting]]
		- [[#PowerShell Remoting Modes#2. Non-Interactive Remoting|2. Non-Interactive Remoting]]
		- [[#PowerShell Remoting Modes#3. Remoting with Multiple Computers|3. Remoting with Multiple Computers]]
		- [[#PowerShell Remoting Modes#4. Persistent Sessions|4. Persistent Sessions]]
	- [[#Powershell Remoting#Authentication Methods|Authentication Methods]]
	- [[#Powershell Remoting#Firewall Configuration|Firewall Configuration]]
	- [[#Powershell Remoting#Common Cmdlets for PowerShell Remoting|Common Cmdlets for PowerShell Remoting]]
	- [[#Powershell Remoting#Examples|Examples]]
		- [[#Examples#Run Commands on a Single Computer|Run Commands on a Single Computer]]
	- [[#Powershell Remoting#Advanced Scenarios|Advanced Scenarios]]
		- [[#Advanced Scenarios#1. Use HTTPS for Secure Communication|1. Use HTTPS for Secure Communication]]
		- [[#Advanced Scenarios#2. Implicit Remoting|2. Implicit Remoting]]
		- [[#Advanced Scenarios#3. Throttling|3. Throttling]]
	- [[#Powershell Remoting#Common Issues|Common Issues]]
	- [[#Powershell Remoting#Best Practices|Best Practices]]
- [[#PS Providers|PS Providers]]
		- [[#Best Practices#Common PSProviders|Common PSProviders]]
			- [[#Common PSProviders#FileSystem|FileSystem]]
			- [[#Common PSProviders#Registry|Registry]]
			- [[#Common PSProviders#Environment|Environment]]
			- [[#Common PSProviders#Function|Function]]
			- [[#Common PSProviders#Variable|Variable]]
			- [[#Common PSProviders#Certificate|Certificate]]
			- [[#Common PSProviders#Alias|Alias]]
			- [[#Common PSProviders#WSMan|WSMan]]
	- [[#PS Providers#List Available PSProviders|List Available PSProviders]]
	- [[#PS Providers#Output Example of `Get-PSProvider`|Output Example of `Get-PSProvider`]]
	- [[#PS Providers#Using a PSProvider|Using a PSProvider]]
		- [[#Using a PSProvider#Example: Navigating the Registry|Example: Navigating the Registry]]
	- [[#PS Providers#Custom PSProviders|Custom PSProviders]]
- [[#PSDrives in Powershell|PSDrives in Powershell]]
	- [[#PSDrives in Powershell#Key Features of PSDrives|Key Features of PSDrives]]
	- [[#PSDrives in Powershell#Viewing Available PSDrives|Viewing Available PSDrives]]
	- [[#PSDrives in Powershell#Example Output of `Get-PSDrive`:|Example Output of `Get-PSDrive`:]]
	- [[#PSDrives in Powershell#Common PSDrives|Common PSDrives]]
	- [[#PSDrives in Powershell#Interacting with PSDrives|Interacting with PSDrives]]
		- [[#Interacting with PSDrives#1. Navigating a PSDrive|1. Navigating a PSDrive]]
		- [[#Interacting with PSDrives#2. Access Environment Variables|2. Access Environment Variables]]
		- [[#Interacting with PSDrives#3. Explore the Certificate Store|3. Explore the Certificate Store]]
	- [[#PSDrives in Powershell#Creating a New PSDrive|Creating a New PSDrive]]
		- [[#Creating a New PSDrive#Syntax:|Syntax:]]
	- [[#PSDrives in Powershell#Removing a PSDrive|Removing a PSDrive]]
	- [[#PSDrives in Powershell#Default vs Custom PSDrives|Default vs Custom PSDrives]]
	- [[#PSDrives in Powershell#Listing Drives for a Specific PSProvider|Listing Drives for a Specific PSProvider]]
	- [[#PSDrives in Powershell#Practical Applications|Practical Applications]]
- [[#WMI and CIM in PowerShell|WMI and CIM in PowerShell]]
	- [[#WMI and CIM in PowerShell#What are WMI and CIM?|What are WMI and CIM?]]
		- [[#What are WMI and CIM?#WMI (Windows Management Instrumentation)|WMI (Windows Management Instrumentation)]]
		- [[#What are WMI and CIM?#CIM (Common Information Model)|CIM (Common Information Model)]]
	- [[#WMI and CIM in PowerShell#WMI vs CIM in PowerShell|WMI vs CIM in PowerShell]]
	- [[#WMI and CIM in PowerShell#PowerShell Cmdlets|PowerShell Cmdlets]]
		- [[#PowerShell Cmdlets#WMI Cmdlets:|WMI Cmdlets:]]
		- [[#PowerShell Cmdlets#CIM Cmdlets:|CIM Cmdlets:]]
	- [[#WMI and CIM in PowerShell#Examples of WMI and CIM in Action|Examples of WMI and CIM in Action]]
		- [[#Examples of WMI and CIM in Action#1. Retrieve System Information|1. Retrieve System Information]]
		- [[#Examples of WMI and CIM in Action#2. Query Processes|2. Query Processes]]
		- [[#Examples of WMI and CIM in Action#3. Restart a Service|3. Restart a Service]]
		- [[#Examples of WMI and CIM in Action#4. Query Remote Systems|4. Query Remote Systems]]
		- [[#Examples of WMI and CIM in Action#5. Get Disk Information|5. Get Disk Information]]
		- [[#Examples of WMI and CIM in Action#6. Create a CIM Session|6. Create a CIM Session]]
	- [[#WMI and CIM in PowerShell#Best Practices|Best Practices]]
	- [[#WMI and CIM in PowerShell#WMI and CIM Namespaces|WMI and CIM Namespaces]]
	- [[#WMI and CIM in PowerShell#Listing Available WMI Classes|Listing Available WMI Classes]]
- [[#Error Handling in Powershell|Error Handling in Powershell]]
	- [[#Error Handling in Powershell#Types of Errors|Types of Errors]]
	- [[#Error Handling in Powershell#Error Action Preferences|Error Action Preferences]]
	- [[#Error Handling in Powershell#Cmdlet-Specific Error Handling|Cmdlet-Specific Error Handling]]
	- [[#Error Handling in Powershell#Try, Catch, and Finally Blocks|Try, Catch, and Finally Blocks]]
		- [[#Try, Catch, and Finally Blocks#Syntax:|Syntax:]]
	- [[#Error Handling in Powershell#Accessing Error Details|Accessing Error Details]]
	- [[#Error Handling in Powershell#Error Handling with Specific Exceptions|Error Handling with Specific Exceptions]]
	- [[#Error Handling in Powershell#Using the `Throw` Statement|Using the `Throw` Statement]]
	- [[#Error Handling in Powershell#Using `$ErrorVariable`|Using `$ErrorVariable`]]
	- [[#Error Handling in Powershell#Trap Statement|Trap Statement]]
	- [[#Error Handling in Powershell#Common Scenarios for Error Handling|Common Scenarios for Error Handling]]
		- [[#Common Scenarios for Error Handling#1. Handle Missing Files|1. Handle Missing Files]]
	- [[#Error Handling in Powershell#Best Practices|Best Practices]]
- [[#Configuration Management with Powershell|Configuration Management with Powershell]]
	- [[#Configuration Management with Powershell#Core Concepts|Core Concepts]]
		- [[#Core Concepts#2. Script-Based Configuration|2. Script-Based Configuration]]
		- [[#Core Concepts#3. Using Desired State Configuration (DSC)|3. Using Desired State Configuration (DSC)]]
	- [[#Configuration Management with Powershell#PowerShell Tools for Configuration Management|PowerShell Tools for Configuration Management]]
	- [[#Configuration Management with Powershell#Examples|Examples]]
		- [[#Examples#Scenario 1: Configure a Batch of Servers|Scenario 1: Configure a Batch of Servers]]
		- [[#Examples#Scenario 2: Enforce Desired Configuration|Scenario 2: Enforce Desired Configuration]]
- [[#Background Jobs in PowerShell|Background Jobs in PowerShell]]
	- [[#Background Jobs in PowerShell#Key Cmdlets for Background Jobs|Key Cmdlets for Background Jobs]]
	- [[#Background Jobs in PowerShell#1. Starting a Background Job|1. Starting a Background Job]]
		- [[#1. Starting a Background Job#1.1 Using `Start-Job`|1.1 Using `Start-Job`]]
	- [[#Background Jobs in PowerShell#2. Monitoring Background Jobs|2. Monitoring Background Jobs]]
		- [[#2. Monitoring Background Jobs#2.1 Check Job Status|2.1 Check Job Status]]
	- [[#Background Jobs in PowerShell#3. Retrieving Job Results|3. Retrieving Job Results]]
		- [[#3. Retrieving Job Results#3.1 Get Output from a Job|3.1 Get Output from a Job]]
		- [[#3. Retrieving Job Results#3.2 Retrieve Output Without Removing Job|3.2 Retrieve Output Without Removing Job]]
	- [[#Background Jobs in PowerShell#4. Removing Background Jobs|4. Removing Background Jobs]]
	- [[#Background Jobs in PowerShell#5. Running Remote Jobs|5. Running Remote Jobs]]
		- [[#5. Running Remote Jobs#Example: Run a Remote Job|Example: Run a Remote Job]]
	- [[#Background Jobs in PowerShell#6. Nested Jobs|6. Nested Jobs]]
		- [[#6. Nested Jobs#Example: Start a Job Within Another Job|Example: Start a Job Within Another Job]]
	- [[#Background Jobs in PowerShell#7. Tracking Multiple Jobs|7. Tracking Multiple Jobs]]
		- [[#7. Tracking Multiple Jobs#Example: Wait for All Jobs to Complete|Example: Wait for All Jobs to Complete]]
	- [[#Background Jobs in PowerShell#8. Handling Errors in Jobs|8. Handling Errors in Jobs]]
		- [[#8. Handling Errors in Jobs#Example: Handle Job Errors|Example: Handle Job Errors]]
	- [[#Background Jobs in PowerShell#9. Scheduled Jobs|9. Scheduled Jobs]]
		- [[#9. Scheduled Jobs#Install Scheduled Jobs Module|Install Scheduled Jobs Module]]
	- [[#Background Jobs in PowerShell#10. Best Practices|10. Best Practices]]
	- [[#Background Jobs in PowerShell#Sample Script: Automate Background Jobs|Sample Script: Automate Background Jobs]]
- [[#Scripting|Scripting]]
	- [[#Scripting#PowerShell Integrated Scripting Environment (ISE)|PowerShell Integrated Scripting Environment (ISE)]]
		- [[#PowerShell Integrated Scripting Environment (ISE)#Key Features of PowerShell ISE:|Key Features of PowerShell ISE:]]
		- [[#PowerShell Integrated Scripting Environment (ISE)#Menu Items and Shortcuts:|Menu Items and Shortcuts:]]
		- [[#PowerShell Integrated Scripting Environment (ISE)#Benefits|Benefits]]
		- [[#PowerShell Integrated Scripting Environment (ISE)#Launching PowerShell ISE:|Launching PowerShell ISE:]]
		- [[#PowerShell Integrated Scripting Environment (ISE)#Menu Bar|Menu Bar]]
		- [[#PowerShell Integrated Scripting Environment (ISE)#Toolbar|Toolbar]]
		- [[#PowerShell Integrated Scripting Environment (ISE)#Scripting Tab|Scripting Tab]]
		- [[#PowerShell Integrated Scripting Environment (ISE)#Status Bar|Status Bar]]
		- [[#PowerShell Integrated Scripting Environment (ISE)#Commands Pane|Commands Pane]]
		- [[#PowerShell Integrated Scripting Environment (ISE)#Text-Size Slide|Text-Size Slide]]
	- [[#Scripting#Basics of Writing Powershell Scripts|Basics of Writing Powershell Scripts]]
		- [[#Basics of Writing Powershell Scripts#Comments|Comments]]
			- [[#Comments#Single-Line Comments|Single-Line Comments]]
			- [[#Comments#Block Comments|Block Comments]]
		- [[#Basics of Writing Powershell Scripts#Brackets, parentheses and braces|Brackets, parentheses and braces]]
			- [[#Brackets, parentheses and braces#Parentheses `()`|Parentheses `()`]]
			- [[#Brackets, parentheses and braces#Brackets `[]`|Brackets `[]`]]
		- [[#Basics of Writing Powershell Scripts#Curly Braces `{}`|Curly Braces `{}`]]
			- [[#Curly Braces `{}`#Comma `,`|Comma `,`]]
		- [[#Basics of Writing Powershell Scripts#Semicolon `;`|Semicolon `;`]]
		- [[#Basics of Writing Powershell Scripts#Pipe `|`|Pipe `|`]]
		- [[#Basics of Writing Powershell Scripts#Backtick <code>`</code>|Backtick <code>`</code>]]
		- [[#Basics of Writing Powershell Scripts#Double Quotation Marks `"`|Double Quotation Marks `"`]]
		- [[#Basics of Writing Powershell Scripts#Single Quotation Marks `'`|Single Quotation Marks `'`]]
		- [[#Basics of Writing Powershell Scripts#Dollar Sign `$`|Dollar Sign `$`]]
	- [[#Scripting#Loops|Loops]]
		- [[#Loops#`For` Loop|`For` Loop]]
		- [[#Loops#`Foreach` Loop|`Foreach` Loop]]
		- [[#Loops#`While` Loop|`While` Loop]]
		- [[#Loops#`Do-While` Loop|`Do-While` Loop]]
		- [[#Loops#`Do-Until` Loop|`Do-Until` Loop]]
		- [[#Loops#`Foreach-Object` Loop|`Foreach-Object` Loop]]
		- [[#Loops#Choosing the Right Loop|Choosing the Right Loop]]
	- [[#Scripting#Conditions in Powershell|Conditions in Powershell]]
		- [[#Conditions in Powershell#`If` Statement|`If` Statement]]
		- [[#Conditions in Powershell#`If-Else` Statement|`If-Else` Statement]]
		- [[#Conditions in Powershell#`If-ElseIf-Else` Statement|`If-ElseIf-Else` Statement]]
		- [[#Conditions in Powershell#`Switch` Statement|`Switch` Statement]]
		- [[#Conditions in Powershell#Comparison Operators in Conditions|Comparison Operators in Conditions]]
		- [[#Conditions in Powershell#Logical Operators|Logical Operators]]
	- [[#Scripting#Scripting Constructs in PowerShell|Scripting Constructs in PowerShell]]
		- [[#Scripting Constructs in PowerShell#1. Conditional Statements|1. Conditional Statements]]
		- [[#Scripting Constructs in PowerShell#1.1. If-Else|1.1. If-Else]]
		- [[#Scripting Constructs in PowerShell#1.2. Switch|1.2. Switch]]
		- [[#Scripting Constructs in PowerShell#2. Loops|2. Loops]]
		- [[#Scripting Constructs in PowerShell#2.1. For Loop|2.1. For Loop]]
		- [[#Scripting Constructs in PowerShell#2.2. Foreach Loop|2.2. Foreach Loop]]
		- [[#Scripting Constructs in PowerShell#2.3. While Loop|2.3. While Loop]]
		- [[#Scripting Constructs in PowerShell#2.4. Do-While Loop|2.4. Do-While Loop]]
		- [[#Scripting Constructs in PowerShell#2.5. Do-Until Loop|2.5. Do-Until Loop]]
		- [[#Scripting Constructs in PowerShell#3. Functions|3. Functions]]
		- [[#Scripting Constructs in PowerShell#Defining a Function|Defining a Function]]
		- [[#Scripting Constructs in PowerShell#4. Arrays and HashTables|4. Arrays and HashTables]]
		- [[#Scripting Constructs in PowerShell#4.1. Arrays|4.1. Arrays]]
		- [[#Scripting Constructs in PowerShell#5. Pipelines|5. Pipelines]]
		- [[#Scripting Constructs in PowerShell#6. Try-Catch-Finally|6. Try-Catch-Finally]]
		- [[#Scripting Constructs in PowerShell#7. Script Blocks|7. Script Blocks]]
		- [[#Scripting Constructs in PowerShell#8. Workflow|8. Workflow]]
		- [[#Scripting Constructs in PowerShell#9. Error Variables|9. Error Variables]]
		- [[#Scripting Constructs in PowerShell#10. Dot Sourcing|10. Dot Sourcing]]
		- [[#Scripting Constructs in PowerShell#11. Comments|11. Comments]]
		- [[#Scripting Constructs in PowerShell#**Best Practices**|**Best Practices**]]
	- [[#Scripting#Provisioning a New Server Core Instance with PowerShell|Provisioning a New Server Core Instance with PowerShell]]
		- [[#Provisioning a New Server Core Instance with PowerShell#1. Initial Configuration|1. Initial Configuration]]
		- [[#Provisioning a New Server Core Instance with PowerShell#1.1 Set Administrator Password|1.1 Set Administrator Password]]
		- [[#Provisioning a New Server Core Instance with PowerShell#1.2 Rename the Server|1.2 Rename the Server]]
		- [[#Provisioning a New Server Core Instance with PowerShell#1.3 Configure Networking|1.3 Configure Networking]]
		- [[#Provisioning a New Server Core Instance with PowerShell#2. Update the Server|2. Update the Server]]
		- [[#Provisioning a New Server Core Instance with PowerShell#2.1 Check for Updates|2.1 Check for Updates]]
		- [[#Provisioning a New Server Core Instance with PowerShell#3. Install Roles and Features|3. Install Roles and Features]]
		- [[#Provisioning a New Server Core Instance with PowerShell#3.1 View Available Features|3.1 View Available Features]]
		- [[#Provisioning a New Server Core Instance with PowerShell#3.2 Install a Role or Feature|3.2 Install a Role or Feature]]
		- [[#Provisioning a New Server Core Instance with PowerShell#4. Join a Domain|4. Join a Domain]]
		- [[#Provisioning a New Server Core Instance with PowerShell#4.1 Join the Server to a Domain|4.1 Join the Server to a Domain]]
		- [[#Provisioning a New Server Core Instance with PowerShell#5. Configure Remote Management|5. Configure Remote Management]]
		- [[#Provisioning a New Server Core Instance with PowerShell#5.1 Enable PowerShell Remoting|5.1 Enable PowerShell Remoting]]
		- [[#Provisioning a New Server Core Instance with PowerShell#6. Configure Firewall|6. Configure Firewall]]
		- [[#Provisioning a New Server Core Instance with PowerShell#6.1 View Firewall Rules|6.1 View Firewall Rules]]
		- [[#Provisioning a New Server Core Instance with PowerShell#6.2 Enable Specific Rules|6.2 Enable Specific Rules]]
		- [[#Provisioning a New Server Core Instance with PowerShell#6.3 Disable Specific Rules|6.3 Disable Specific Rules]]
		- [[#Provisioning a New Server Core Instance with PowerShell#7. Configure Server Time|7. Configure Server Time]]
		- [[#Provisioning a New Server Core Instance with PowerShell#7.1 View Current Time Zone|7.1 View Current Time Zone]]
		- [[#Provisioning a New Server Core Instance with PowerShell#8. Configure Scheduled Tasks|8. Configure Scheduled Tasks]]
		- [[#Provisioning a New Server Core Instance with PowerShell#8.1 Create a Task|8.1 Create a Task]]
		- [[#Provisioning a New Server Core Instance with PowerShell#9. Security Hardening|9. Security Hardening]]
		- [[#Provisioning a New Server Core Instance with PowerShell#9.1 Disable SMBv1|9.1 Disable SMBv1]]
		- [[#Provisioning a New Server Core Instance with PowerShell#10. Backup Configuration|10. Backup Configuration]]
		- [[#Provisioning a New Server Core Instance with PowerShell#10.1 Install Windows Server Backup|10.1 Install Windows Server Backup]]
	- [[#Scripting#Sample Script for Full Automation|Sample Script for Full Automation]]
		- [[#Sample Script for Full Automation#Verification Checklist|Verification Checklist]]
	- [[#Scripting#Example Scripts for IT Professionals|Example Scripts for IT Professionals]]
		- [[#Example Scripts for IT Professionals#Enforcing Desired State Configuration (DSC) Script|Enforcing Desired State Configuration (DSC) Script]]
			- [[#Enforcing Desired State Configuration (DSC) Script#Core Concepts of Desired State Configuration|Core Concepts of Desired State Configuration]]
			- [[#Enforcing Desired State Configuration (DSC) Script#Workflow of DSC|Workflow of DSC]]
			- [[#Enforcing Desired State Configuration (DSC) Script#DSC in Action|DSC in Action]]
			- [[#Enforcing Desired State Configuration (DSC) Script#Example DSC Script|Example DSC Script]]
		- [[#Example Scripts for IT Professionals#Monitor a Web Page for Changes|Monitor a Web Page for Changes]]
		- [[#Example Scripts for IT Professionals#Check Disk Space|Check Disk Space]]
		- [[#Example Scripts for IT Professionals#Automate User Creation in Active Directory|Automate User Creation in Active Directory]]
		- [[#Example Scripts for IT Professionals#Backup Event Logs|Backup Event Logs]]
		- [[#Example Scripts for IT Professionals#Monitor Service Status|Monitor Service Status]]
		- [[#Example Scripts for IT Professionals#Clear Old Files|Clear Old Files]]
		- [[#Example Scripts for IT Professionals#Export Installed Software List|Export Installed Software List]]
		- [[#Example Scripts for IT Professionals#Reset User Password|Reset User Password]]
		- [[#Example Scripts for IT Professionals#Check for Pending Windows Updates|Check for Pending Windows Updates]]
		- [[#Example Scripts for IT Professionals#Schedule a Task|Schedule a Task]]
	- [[#Scripting#Example Scripts for Cyber Security|Example Scripts for Cyber Security]]
		- [[#Example Scripts for Cyber Security#Scan for Open Ports on a Machine|Scan for Open Ports on a Machine]]
		- [[#Example Scripts for Cyber Security#Check File Integrity|Check File Integrity]]
		- [[#Example Scripts for Cyber Security#Search for Malicious Processes|Search for Malicious Processes]]
		- [[#Example Scripts for Cyber Security#Monitor Unauthorized Login Attempts|Monitor Unauthorized Login Attempts]]
		- [[#Example Scripts for Cyber Security#Block Malicious IP Addresses|Block Malicious IP Addresses]]
		- [[#Example Scripts for Cyber Security#Detect Hidden Files|Detect Hidden Files]]
		- [[#Example Scripts for Cyber Security#Retrieve Suspicious Network Connections|Retrieve Suspicious Network Connections]]
		- [[#Example Scripts for Cyber Security#Audit Installed Software|Audit Installed Software]]
		- [[#Example Scripts for Cyber Security#Export Security Logs|Export Security Logs]]
		- [[#Example Scripts for Cyber Security#Check for Privilege Escalation Attempts|Check for Privilege Escalation Attempts]]
		- [[#Example Scripts for Cyber Security#Detect Anomalous Scheduled Tasks|Detect Anomalous Scheduled Tasks]]
		- [[#Example Scripts for Cyber Security#Find Recent PowerShell Command History|Find Recent PowerShell Command History]]
	- [[#Scripting#Common Powershell Tools in Cyber Security|Common Powershell Tools in Cyber Security]]
		- [[#Common Powershell Tools in Cyber Security#Powersploit|Powersploit]]
		- [[#Common Powershell Tools in Cyber Security#Modules in PowerSploit|Modules in PowerSploit]]
			- [[#Modules in PowerSploit#1. CodeExecution|1. CodeExecution]]
			- [[#Modules in PowerSploit#2. Persistence|2. Persistence]]
			- [[#Modules in PowerSploit#3. Privesc (Privilege Escalation)|3. Privesc (Privilege Escalation)]]
			- [[#Modules in PowerSploit#4. Recon|4. Recon]]
			- [[#Modules in PowerSploit#5. AntivirusBypass|5. AntivirusBypass]]
			- [[#Modules in PowerSploit#6. Exfiltration|6. Exfiltration]]
			- [[#Modules in PowerSploit#7. Post-Exploitation|7. Post-Exploitation]]
		- [[#Common Powershell Tools in Cyber Security#How PowerSploit Works|How PowerSploit Works]]
		- [[#Common Powershell Tools in Cyber Security#Example Usage of PowerSploit|Example Usage of PowerSploit]]
			- [[#Example Usage of PowerSploit#1. Shellcode Execution|1. Shellcode Execution]]
			- [[#Example Usage of PowerSploit#2. Privilege Escalation with PowerUp|2. Privilege Escalation with PowerUp]]
			- [[#Example Usage of PowerSploit#3. Extracting Credentials with Invoke-Mimikatz|3. Extracting Credentials with Invoke-Mimikatz]]
			- [[#Example Usage of PowerSploit#4. Persistent Backdoor|4. Persistent Backdoor]]
			- [[#Example Usage of PowerSploit#5. Reconnaissance|5. Reconnaissance]]
		- [[#Common Powershell Tools in Cyber Security#Invoke-Mimikatz|Invoke-Mimikatz]]
			- [[#Invoke-Mimikatz#What is Mimikatz?|What is Mimikatz?]]
			- [[#Invoke-Mimikatz#Capabilities of Invoke-Mimikatz|Capabilities of Invoke-Mimikatz]]
			- [[#Invoke-Mimikatz#Using Invoke-Mimikatz|Using Invoke-Mimikatz]]
			- [[#Invoke-Mimikatz#Understanding the Output|Understanding the Output]]
			- [[#Invoke-Mimikatz#Examples|Examples]]
			- [[#Invoke-Mimikatz#Execution Methods|Execution Methods]]
		- [[#Common Powershell Tools in Cyber Security#Nishang|Nishang]]
			- [[#Nishang#Features of Nishang|Features of Nishang]]
			- [[#Nishang#Modules in Nishang|Modules in Nishang]]
			- [[#Nishang#How Nishang Works|How Nishang Works]]
			- [[#Nishang#Common Use Cases|Common Use Cases]]
- [[#Done !|Done !]]
